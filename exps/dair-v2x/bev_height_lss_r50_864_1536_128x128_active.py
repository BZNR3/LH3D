...
import sys, os
# BEVHEIGHT_ROOT = "/path/to/workplace"
...
def run_cli():
    ...
    precision=32, default_root_dir='/data/<user>/outputs/bev_height_<exp>'
)
    # Object budget CLI
    ...
    # Automatically append the active learning method name to the output directory
